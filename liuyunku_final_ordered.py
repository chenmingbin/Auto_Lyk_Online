...
class LiuYunKuNavigationAutomator:
    ...
    def click_category_and_get_subcategories(self, category: Dict) -> List[Dict]:
        """
        点击大类触发细分项菜单，并获取细分项
        ...
        try:
            ...
            # 查找大类下的可点击项（通常是"全部"或第一个细分项）
            # 在大类容器内查找第一个li元素
            first_item = category["element"].query_selector("ul li")
    ...
    def save_navigation_data(self, data: Dict, filename: str = "liuyunku_navigation_final.json") -> bool:
        """保存导航数据到文件"""
        try:
